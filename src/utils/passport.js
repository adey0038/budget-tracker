...
import { Strategy as GoogleStrategy } from "passport-google-oauth20"; //specifically Google OAuth
import { Strategy as BearerStrategy } from "passport-http-bearer"; //Handle Authorization Headers
...
passport.use(
  new GoogleStrategy(
    googleClient,
    async (_accessToken, _refreshToken, profile, complete) => {
      try {
